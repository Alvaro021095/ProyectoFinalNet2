...
namespace Platform.Entity.Entity
{
    ...
    public partial class ProyNet2Entities : DbContext
    {
        ...
        public virtual int crearProyecto(string nombre, Nullable<System.DateTime> fecha_ini, Nullable<System.DateTime> fecha_fin, string etapa, Nullable<int> cargoId, Nullable<int> directorId)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("nombre", nombre) :
                new ObjectParameter("nombre", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("crearProyecto", nombreParameter, fecha_iniParameter, fecha_finParameter, etapaParameter, cargoIdParameter, directorIdParameter);
        }
        ...
        public virtual int editarProyecto(Nullable<int> id, string nombre, Nullable<System.DateTime> fecha_ini, Nullable<System.DateTime> fecha_fin, string etapa, Nullable<int> cargoId, Nullable<int> directorId)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("editarProyecto", idParameter, nombreParameter, fecha_iniParameter, fecha_finParameter, etapaParameter, cargoIdParameter, directorIdParameter);
        }
